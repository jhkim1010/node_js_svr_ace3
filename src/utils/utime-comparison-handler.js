                ...
                if (modelName === 'Codigos' || modelName === 'Todocodigos') {
                    ...
                    try {
                        ...
                        if (isUniqueConstraintError(createErr)) {
                            ...
                            logInfoWithLocation(`SKIP: ${modelName} INSERT skipped due to unique constraint`);
                        ...
                        // 4단계: FOREIGN KEY 제약 조건 에러 → 어떤 외래키 인지 출력 후 SKIP
                            ...
                            logInfoWithLocation(`SKIP: ${modelName} INSERT skipped due to foreign key constraint`);
                            console.log(`   Constraint Name: ${constraintName}`);
                            console.log(`   Foreign Key Column: ${fkColumn}`);
